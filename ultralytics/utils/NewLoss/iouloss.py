...
def bbox_multi_iou(box1, box2, xywh=False, GIoU=False, UIoU=False, DIoU=False, CIoU=False, EIoU=False, SIoU=False, WIoU=False, EfficiCIoU=False, XIoU=False, is_Focaler='None', eps=1e-7):
    ...
    '''
        ...
        1.  Need to comment on this string of code   Cancel 

        2.  This file 95.96 Comment on code 
    ...
    # FocalerIoU  improve 
    # Focaler = False
    # Thay đổi thành True để sử dụng FocalerIoU,...
    Focaler = True
    if Focaler:
        d=0.0
        u=0.95
        # print('use Focaler series 🍈')
