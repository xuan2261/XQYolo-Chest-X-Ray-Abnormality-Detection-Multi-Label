...
'''
YOLOv8 + repulsionloss  Loss function "  improve 
-  Just need to add the core of the corresponding improvement  repulsionloss  Loss function module ， This item code can run directly `YOLOv8-xxx.yaml` Network configuration file ， Lego -style innovation improvement ， Just run in one click 
 use  repulsionloss  Loss function   Experimental improvement 
-  Project -related improvement can support   Answer questions   Serve 。 See for details  ⭐⭐⭐ https://github.com/iscyy/ultralyticsPro/wiki/YOLOv8 ⭐⭐⭐  illustrate 
'''
