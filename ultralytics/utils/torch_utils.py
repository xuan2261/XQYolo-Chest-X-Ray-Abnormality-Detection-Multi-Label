...
def init_seeds(seed=0, deterministic=False):
    ...
    if deterministic:
        if TORCH_2_0:
            # warn_only=True cho phép huấn luyện tiếp tục khi gặp hoạt động không có triển khai xác định như adaptive_max_pool2d_backward_cuda
            torch.use_deterministic_algorithms(True, warn_only=True)  # cho phép hiển thị cảnh báo thay vì dừng chương trình
