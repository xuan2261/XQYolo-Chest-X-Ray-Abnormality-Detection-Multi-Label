...
#  about ModuleNotFoundError: No module named 'selective_scan_cuda'
#  Refer to this tutorial installation  https://github.com/AlwaysFHao/Mamba-Install


'''
 Need in linux Next compile 
 or 
